            ...
            <div class="row row-cards">
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="mb-3">
                        ...
                        <x-text-input type="number" class="form-control" wire:model.debounce.350='item.wholesale_cost_price' />
                ...
                <div class="row row-cards">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <x-text-input type="number" class="form-control" wire:model.debounce.350='item.retail_price_for_block' />
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <x-text-input type="number" class="form-control" wire:model.debounce.350='item.retail_price_for_half_block' />
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <x-text-input type="number" class="form-control" wire:model.debounce.350='item.retail_price' />
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <x-text-input type="number" class="form-control" wire:model.debounce.350='item.retail_cost_price' />
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <x-text-input type="number" class="form-control" wire:model.debounce.350='item.retail_count_for_wholesale' />
