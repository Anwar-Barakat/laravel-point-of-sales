<div>
                        ...
                        <div class="col-12 col-md-4 col-lg-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" wire:model='report_type' required>
                                    ...
                                    <option value="5">{{ __('report.services_of', ['name' => __('stock.delegate')]) }}</option>
                                </select>
    ...
    @if ($sales || $transactions || $services)
        <div class="mt-4">
            <div class="card card-lg border-b-0">
                <h1 class="text-center mt-3 text-blue card-title">
                    ...
                    @elseif($report_type == 5)
                        {{ __('report.services_of', ['name' => __('stock.delegate')]) }}
                    @endif
                </h1>
            ...
            @if ($sales && ($report_type == 3 || $report_type == 1 || $report_type == 2))
                <div class="card card-lg border-b-0">
                    <div class="card-header">
            ...
            @if ($services && ($report_type == 5 || $report_type == 1 || $report_type == 2))
                <div class="card card-lg border-b-0">
                    <div class="card-header">
            ...
            @if ($transactions && ($report_type == 4 || $report_type == 1 || $report_type == 2))
                <div class="card card-lg border-b-0">
                    <div class="card-header">
