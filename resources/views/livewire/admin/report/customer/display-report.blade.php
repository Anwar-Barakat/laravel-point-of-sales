<div>
                        ...
                        <div class="col-12 col-md-4 col-lg-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" wire:model='report_type' required>
                                    ...
                                    <option value="6">{{ __('report.services_of', ['name' => __('stock.customer')]) }}</option>
                                </select>
    ...
    @if ($sales || $transactions || $general_sale_returns || $services)
        <div class="mt-4">
            <div class="card card-lg border-b-0">
                <h1 class="text-center mt-3 text-blue card-title">
                    ...
                    @elseif($report_type == 6)
                        {{ __('report.services_of', ['name' => __('stock.customer')]) }}
                    @endif
                </h1>
            ...
            @if ($general_sale_returns && ($report_type == 4 || $report_type == 1 || $report_type == 2))
                <div class="card card-lg border-b-0">
                    <div class="card-header">
