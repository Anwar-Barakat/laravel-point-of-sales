<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        <h3 class="card-title">{{ __('msgs.all', ['name' => __('transaction.workshops_invoices')]) }}</h3>
        <a href="{{ route('admin.workshop-invoices.create') }}" class="btn btn-primary">
            {{ __('msgs.create', ['name' => __('transaction.workshop_invoice')]) }}
        </a>
    </div>
    <div class="card-body">
        <div id="table-default" class="table-responsive">
            ...
            <table id="dataTables" class="table table-vcenter table-mobile-md card-table">
                ...
                <tbody class="table-tbody">
                    @forelse ($workshopInvoices as $invoice)
                        <tr>
                            <td>{{ $invoice->id }}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('admin.workshops.show', ['workshop' => $invoice->workshop]) }}">
                            ...
                            <td>
                                <span class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        @if ($invoice->is_approved == 0)
                                            <a href="{{ route('admin.workshop-invoices.edit', ['workshop_invoice' => $invoice]) }}" class="dropdown-item d-flex align-items-center gap-1">
                                            ...
                                            <a class="dropdown-item d-flex align-items-center gap-1" href="{{ route('admin.workshop-invoices.show', ['workshop_invoice' => $invoice]) }}">
                                            ...
                                            @if (!$invoice->workshopItems->count() > 0)
                                        ...
                                        @else
                                            ...
                                            <a class="dropdown-item d-flex align-items-center gap-1" href="{{ route('admin.workshop-invoices.bill', ['invoice' => $invoice]) }}">
                                ...
                                <x-modal-delete :id="$invoice->id" :action="route('admin.workshop-invoices.destroy', ['workshop_invoice' => $invoice])" />
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="8">
                                <x-blank-section :content="__('transaction.workshop_invoice')" :url="route('admin.workshop-invoices.create')" />
                            </td>
                        </tr>
                    @endforelse
                </tbody>
            ...
            <div class="p-3 mt-2">
                {{ $workshopInvoices->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </div>
