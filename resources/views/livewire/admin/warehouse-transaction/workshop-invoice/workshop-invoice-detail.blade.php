    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-4 mb-3">
            <div class="card">
                ...
                @include('livewire.admin.warehouse-transaction.workshop-invoice.inc.main-detail', ['invoice' => $invoice])
    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="card">
                ...
                @include('livewire.admin.warehouse-transaction.workshop-invoice.inc.display-items', ['workshopInvoiceItems' => $workshopInvoiceItems])
                <div class="card-footer border-top-0">
                </div>
            </div>
        </div>
