                        ...
                        <div class="row row-cards">
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <x-text-input type="text" class="form-control" placeholder="{{ __('unit.unit_ar') }}" :value="old('name_ar')" name='name_ar' required />
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <x-text-input type="text" class="form-control" placeholder="{{ __('unit.unit_en') }}" :value="old('name_en')" name='name_en' required />
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select id="" class="form-control" name='status'>
                                        <option value="">{{ __('btns.select') }}</option>
                                        <option value="retail" {{ old('is_active') == 'retail' ? 'selected' : '' }}>{{ __('unit.retail') }}</option>
                                        <option value="wholesale" {{ old('is_active') == 'wholesale' ? 'selected' : '' }}>{{ __('unit.wholesale') }}</option>
                                    </select>
