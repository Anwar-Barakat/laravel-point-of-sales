<div class="col-3 d-none d-md-block border-end">
    <div class="card-body">
        ...
        <div class="list-group list-group-transparent">
            <a href="{{ route('admin.setting.company') }}" class="list-group-item list-group-item-action d-flex align-items-center {{ request()->routeIs('admin.setting.company') ? 'active' : '' }}">{{ __('setting.company_setting') }}</a>
